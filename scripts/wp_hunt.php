<?php
	...
	function sendRequest($url,$ssl=false){
		$agent ="'Mozilla/5.0 (Windows NT 6.2; WOW64; rv:101.0) Gecko/20100101 Firefox/101.0';";
		$ch = curl_init();
			...
			for($i=0;$i<=count($array);$i++){
				...
				$j++;
					...
					// }	
						...
						// CREDS OF THE MAIN USER's IN WORDPRESS 
						/*
							USERS:
								mcaballero
									P(9NE@Zw*R0P9]SpB1Vo
						*/
				...
				echo "[+] Sucuri: ".$s["scans"]['Sucuri']['result']."\n"; // 
